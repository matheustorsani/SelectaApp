    ...
    return (
        <ScrollView style={Styles.Main} contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ flexDirection: "row", flexWrap: "nowrap", justifyContent: "space-between" }}>
                <OptionCard disabled={true} itens={2} bgColor="white" color="black" icon="trending-up" text="Relatórios" />
                <OptionCard disabled={true} itens={2} bgColor="white" color="black" icon="dollar-sign" text="Pagamentos" />
            </View>
